    ...
    <svg width={size} height={size} className="shrink-0">
      ...
      <defs>
        <linearGradient id="ringGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#9B78D6" />
          <stop offset="100%" stopColor="#5B3597" />
        </linearGradient>
      </defs>
    </svg>
  );
      ...
      >
        <div className="flex items-center gap-2 px-2 mb-8">
          ...
          <div className="hidden md:block leading-tight">
            ...
            <div className="text-[10px]" style={{ color: '#C9B6EE' }}>
              Semester 2
            </div>
          </div>
        </div>
        ...
        <div
          ...
          style={{ background: 'rgba(255,255,255,0.08)' }}
        >
          <Flame size={16} color="#E9C46A" />
          <div className="text-[11px] text-white leading-tight">
            <div className="font-bold">Keep going</div>
            <div style={{ color: '#C9B6EE' }}>Ch.1-3 due 30 Sep</div>
          </div>
        </div>
      </aside>
            ...
            >
              ...
              <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 gap-3 w-full">
                <div>
                  ...
                  <div className="text-[11px]" style={{ color: '#D6C2F0' }}>
                    Topics done
                  </div>
                </div>
                <div>
